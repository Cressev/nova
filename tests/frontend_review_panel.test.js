...
assert(html.includes('id="quality-gate-summary"'), "Review 面板应该显示质量门禁摘要");
...
assert(app.includes("renderQualityGateSummary"), "前端应该渲染质量门禁状态");
assert(css.includes(".review-panel"), "Review 面板需要独立样式");
assert(css.includes(".quality-gate-summary"), "质量门禁摘要需要独立样式");
